...
function ProductTable() {
  ...
  const handleProductDelete = (id)       => dispatch(deleteProduct(id));
  const handleChangePage    = (_, newPage) => setPage(newPage);

  useEffect(() => {
    dispatch(findProducts({
      category: "", colors: [], sizes: [],
      minPrice: 0, maxPrice: 100000, minDiscount: 0,
      sort: "price_low", pageNumber: page,
      pageSize: ROWS_PER_PAGE, stock: "",
    }));
              ...
              >
                ...
                <TableCell sx={bodyCell}>
                  <Box sx={{
                    ...
                    px: 1.2, py: 0.3, borderRadius: "6px", background: "#f0fdf4",
                  }}>
                    <CategoryIcon sx={{ fontSize: 11, color: "#10b981" }} />
                    <Typography sx={{ fontSize: "0.72rem", fontWeight: 600, color: "#059669", whiteSpace: "nowrap" }}>
                      {item.category.name}
                    </Typography>
                  </Box>
                </TableCell>
