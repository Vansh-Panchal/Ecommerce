...
import { Avatar, AvatarGroup, Box, Button, Card, Typography } from '@mui/material';
...
function OrdersTable() {
  ...
  const handleClick      = (e, id) => { setAnchorEl(e.currentTarget); setSelectedOrderId(id); };
  ...
  const handleShippedOrder   = (id) => { dispatch(shipOrder(id));      handleClose(); };
  const handleConfirmedOrder = (id) => { dispatch(confirmOrder(id));   handleClose(); };
  const handleDeliveredOrder = (id) => { dispatch(deliveredOrder(id)); handleClose(); };
  const handleDeleteOrder    = (id) => { dispatch(deleteOrder(id)); };

  // Client-side pagination slice
  const allOrders   = adminOrder?.orders || [];
  const pagedOrders = allOrders.slice(page * ROWS_PER_PAGE, page * ROWS_PER_PAGE + ROWS_PER_PAGE);
  ...
  const bodyCell = { borderBottom: "1px solid #f8f9fe", py: 1.5, px: 2 };
  ...
  return (
    <Card sx={{
      ...
      {/* Header */}
      <Box sx={{
        px: 3, pt: 2.5, pb: 1.5, flexShrink: 0,
      ...
      {/* Table — overflowX:auto handles narrow screens */}
                ...
                >
                  ...
                  <TableCell sx={bodyCell}>
                    <Button
                      ...
                      sx={{
                        borderRadius: "8px", background: "#eef2ff", color: "#6366f1",
                        fontWeight: 600, fontSize: "0.72rem", textTransform: "none",
                  ...
                  <TableCell sx={bodyCell}>
                    <Button
                      ...
                      sx={{
                        ...
                        color: "#ef4444", fontWeight: 600, fontSize: "0.72rem",
      ...
      {/* Pagination */}
      <Box sx={{ borderTop: "1px solid #eef0f8", flexShrink: 0 }}>
        <TablePagination
          component="div"
