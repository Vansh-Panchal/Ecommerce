      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer", color: "#aaa", fontSize: "0.75rem",
                  fontWeight: 600,
                }}
              >
          ...
          <div style={{ textAlign: "right", marginBottom: "22px" }}>
            <span style={{ fontSize: "0.78rem", color: "#c9a84c", cursor: "pointer", fontWeight: 600 }}>
              Forgot password?
            </span>
          </div>
        ...
        <button
          ...
          style={{
            ...
            fontSize: "0.84rem", fontWeight: 600, color: "#444",
